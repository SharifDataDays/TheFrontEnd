...
class fields_ForgotFields extends external_react_["Component"] {
  ...
  sendEmail() {
    ...
    Object(auth["b" /* forgotAPI */])(this.email.state.value).then(res => {
...
/* harmony default export */ var email = __webpack_exports__["default"] = (Object(withAuth["a" /* default */])(false)(email_LoginPage));
