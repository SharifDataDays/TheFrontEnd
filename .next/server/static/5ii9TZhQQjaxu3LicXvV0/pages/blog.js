...
function First({
  ...
  return __jsx(external_semantic_ui_react_["Card"], {
    ...
    wrapped: true,
    ui: false
  }), __jsx(external_semantic_ui_react_["Card"].Content, {
    style: {
      direction: 'rtl'
    }
  }, __jsx(external_semantic_ui_react_["Card"].Header, null, title), __jsx(external_semantic_ui_react_["Card"].Meta, null, external_jalali_moment_default.a.from(date, 'en').locale('fa').fromNow()), __jsx(external_semantic_ui_react_["Card"].Description, null, description)));
}
function Rest({
  title,
  description,
  ...
  }), __jsx(external_semantic_ui_react_["Item"].Content, {
    style: {
      direction: 'rtl'
    }
  }, __jsx(external_semantic_ui_react_["Item"].Header, {
    as: "a"
...
class blog_Blog extends external_react_["Component"] {
  static async getInitialProps(ctx, token) {
    const res = await Object(blog["a" /* blogHomeAPI */])();
  ...
  render() {
    ...
    return blog_jsx(external_react_default.a.Fragment, null, blog_jsx(head_default.a, null, blog_jsx("title", null, "\u0628\u0644\u0627\u06AF DataDays")), blog_jsx(layout["a" /* default */], {
      token: token,
      hasNavbar: true,
      hasFooter: true
    }, blog_jsx(headerImage, null), blog_jsx(blog_posts, {
      posts: posts
    })));
  }
