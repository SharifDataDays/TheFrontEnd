...
// CONCATENATED MODULE: ./components/global/font.js
...
const Fonts = () => {
  ...
  const iransans = new external_fontfaceobserver_default.a('IRANSans');
  iransans.load().then(() => {
    document.documentElement.classList.add('iransans');
  });
};

/* harmony default export */ var font = (Fonts);
...
class _document_MyDocument extends document_default.a {
  static async getInitialProps(ctx) {
    ...
    external_react_ga_default.a.initialize('UA-155058832-1');
    external_react_ga_default.a.pageview(ctx.req.url);
  ...
  render() {
    return __jsx(next_document["Html"], null, __jsx(next_document["Head"], null, __jsx("link", {
      rel: "shortcut icon",
