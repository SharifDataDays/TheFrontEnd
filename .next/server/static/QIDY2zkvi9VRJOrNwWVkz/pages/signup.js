...
function mapDispatchToProps(dispatch, ownProps) {
  return {
    request: fields => {
      dispatch(Object(actions_signup["g" /* signupAction */])(fields));
    }
  };
}

/* harmony default export */ var signup_form = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(form_Form));
...
function container_mapStateToProps(state, ownProps) {
  const {
    signup
  } = state;
  return {
...
/* harmony default export */ var signup_container = (Object(external_react_redux_["connect"])(container_mapStateToProps)(SignupContainer));
// EXTERNAL MODULE: ./redux/api/index.js
var api = __webpack_require__("eNjs");
...
class signup_SignupPage extends external_react_["Component"] {
  static async getInitialProps(ctx) {
    const res = await external_isomorphic_unfetch_default()(Object(api["c" /* termsAPI */])());
...
/* harmony default export */ var pages_signup = __webpack_exports__["default"] = (Object(withAuth["a" /* default */])(false)(signup_SignupPage));
