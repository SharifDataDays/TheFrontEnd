...
module.exports = __webpack_require__("o803");
...
// CONCATENATED MODULE: ./components/user/forgot/email/check.js
...
function check(fields) {
  ...
  if (!external_validator_default.a.isEmail(fields.email)) {
...
/* harmony default export */ var email_check = (check);
// EXTERNAL MODULE: ./redux/api/auth.js
var auth = __webpack_require__("+YYQ");

// CONCATENATED MODULE: ./components/user/forgot/email/fields.jsx
var __jsx = external_react_default.a.createElement;
...
class fields_ForgotFields extends external_react_["Component"] {
  ...
  onSubmit() {
    this.setState(prevState => {
      const res = email_check(prevState);
  ...
  email() {
    ...
    external_axios_default.a.post(Object(auth["b" /* forgotAPI */])(), {
      email
    }).then(res => {
...
// CONCATENATED MODULE: ./components/user/forgot/email/container.jsx
...
function container_notify(choice) {
  ...
  switch (choice) {
    case 'incompleteFields':
      external_react_toastify_["toast"].error('فیلد‌های مشخص شده باید کامل شوند.', options);
      break;

    case 'invalidEmail':
      external_react_toastify_["toast"].error('ایمیل وارد شده صحیح نیست.', options);
      break;

    case 'emailNotExists':
      external_react_toastify_["toast"].error('ایمیل وارد‌شده وجود ندارد.', options);
      break;

    case 'success':
      external_react_toastify_["toast"].success('ایمیل ارسال شد.', options);
      break;
...
/* harmony default export */ var email_container = (EmailContainer);
// CONCATENATED MODULE: ./pages/forgot/email.jsx
...
class email_LoginPage extends external_react_["Component"] {
  render() {
    return email_jsx(external_react_default.a.Fragment, null, email_jsx(head_default.a, null, email_jsx("title", null, "\u0641\u0631\u0627\u0645\u0648\u0634\u06CC \u0631\u0645\u0632 \u0639\u0628\u0648\u0631 - DataDays 2020")), email_jsx(email_container, null));
  }

}

/* harmony default export */ var forgot_email = __webpack_exports__["default"] = (Object(withAuth["a" /* default */])(false)(email_LoginPage));
