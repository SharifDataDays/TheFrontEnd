...
/* harmony import */ var _components_global_layout__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../components/global/layout */ "./components/global/layout.jsx");
...
class Dashboard extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  static async getInitialProps(ctx, token) {
    ...
    console.log(token);
    const res = await Object(_redux_api_dashboard__WEBPACK_IMPORTED_MODULE_2__["contestAPI"])(contestNumber, token);
    const {
      contest
    } = res.data;
    console.log(res);
    ...
    for (let id = 0; id < contest.milestones.length; id++) {
      const res = await Object(_redux_api_dashboard__WEBPACK_IMPORTED_MODULE_2__["milestoneAPI"])(contestNumber, contest.milestones[id], token);
      const {
        milestone
      } = res.data;
  ...
  render() {
    ...
    return __jsx(_components_global_layout__WEBPACK_IMPORTED_MODULE_4__["default"], {
      token: token,
      hasNavbar: true,
      hasFooter: true,
      __source: {
      ...
      __self: this
    }, __jsx(_components_dashboard_main_milestones__WEBPACK_IMPORTED_MODULE_1__["default"], {
      contest: contest,
