...
var GenerateRows = function GenerateRows(_ref2) {
  ...
  var rows = teams.map(function (x) {
    ...
    var borderRight = "3px solid ".concat(background, " !important"); // if (x.name === myName) return <GenerateMyRow name={x.name} score="10" rank={x.rank} />;
...
//# sourceMappingURL=scoreboard.js.045475605f10445ac49f.hot-update.js.map