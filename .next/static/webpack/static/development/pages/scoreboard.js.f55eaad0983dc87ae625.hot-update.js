...
var GenerateRows = function GenerateRows(_ref2) {
  ...
  var newTeams = teams.slice(topRank - 1, topRank + 9);
...
var Footer = function Footer(props) {
  ...
  var pageNumbers = Math.ceil(numberOfTeams / 10);
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_7___default.a.Fragment, null, __jsx(Info, {
    ...
    __self: this
  }, "\u0631\u062A\u0628\u0647\u200C\u0647\u0627\u06CC 1 \u0627\u0644\u06CC 10"), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_8__["Table"].Row, {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 89
    },
...
function onPageChange(e, pageInfo) {
  var newTopRank = (pageInfo.activePage - 1) * 10 + 1;
  this.setState({
    topRank: newTopRank
  });
}
...
//# sourceMappingURL=scoreboard.js.f55eaad0983dc87ae625.hot-update.js.map