...
/* harmony import */ var _input__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./input */ "./components/dashboard/profile/input.jsx");
/* harmony import */ var _date__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./date */ "./components/dashboard/profile/date.jsx");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./utils */ "./components/dashboard/profile/utils.js");
...
/*#__PURE__*/
function (_Component) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_12__["default"])(Form, _Component);

  function Form(props) {
    var _this;

    Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_7__["default"])(this, Form);

    _this = Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_9__["default"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_10__["default"])(Form).call(this, props));
    _this.onSubmit = _this.onSubmit.bind(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_11__["default"])(_this));
    return _this;
  }

  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_8__["default"])(Form, [{
    key: "onSubmit",
    value: function onSubmit() {
      ...
      var new_fields = {
        ...
        profile: {
          ...
          birth_date: lodash__WEBPACK_IMPORTED_MODULE_13___default.a.join(lodash__WEBPACK_IMPORTED_MODULE_13___default.a.reverse(lodash__WEBPACK_IMPORTED_MODULE_13___default.a.split(this.birth_date.state.value, '-')), '-')
        }
      };
      update(new_fields);
    }
    ...
    value: function render() {
      ...
      var profileData = _objectSpread({}, this.props.profileData.email, {}, this.props.profileData.profile);

      console.log(profileData);
      return __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_15__["Grid"], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 39
        },
        __self: this
      }, __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_15__["Grid"].Column, {
        ...
        __self: this
      }, __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_15__["Form"], {
        ...
        __self: this
      }, lodash__WEBPACK_IMPORTED_MODULE_13___default.a.map(_utils__WEBPACK_IMPORTED_MODULE_18__["fields"], function (field) {
        {
          console.log(field);
          console.log(_this2[field.en]);
          console.log(errors[field.en]);
          console.log(profileData[field.en]);
        }

        __jsx(_input__WEBPACK_IMPORTED_MODULE_16__["default"], {
          ref: function ref(c) {
            _this2[field.en] = c;
          },
          field: field,
      ...
      }), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_15__["Message"], {
        hidden: !success,
        positive: true,
        __source: {
          fileName: _jsxFileName,
        ...
        __self: this
      }, "\u062A\u063A\u06CC\u06CC\u0631\u0627\u062A \u0628\u0627 \u0645\u0648\u0641\u0642\u06CC\u062A \u0630\u062E\u06CC\u0631\u0647 \u0634\u062F."), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_15__["Form"].Button, {
        primary: true,
...
//# sourceMappingURL=profile.js.861c981f3547d0836521.hot-update.js.map