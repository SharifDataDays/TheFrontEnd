...
/* harmony import */ var _input__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./input */ "./components/dashboard/profile/input.jsx");
...
/*#__PURE__*/
function (_Component) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_13__["default"])(Form, _Component);

  function Form(props) {
    var _this;

    Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_8__["default"])(this, Form);

    _this = Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_10__["default"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_11__["default"])(Form).call(this, props));
    _this.onSubmit = _this.onSubmit.bind(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_12__["default"])(_this));
    return _this;
  }

  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_9__["default"])(Form, [{
    key: "onSubmit",
      ...
      if (this.props.type === 'profile') {
        var new_fields = {
          profile: {
            ...
            birth_date: lodash__WEBPACK_IMPORTED_MODULE_14___default.a.join(lodash__WEBPACK_IMPORTED_MODULE_14___default.a.reverse(lodash__WEBPACK_IMPORTED_MODULE_14___default.a.split(this.birth_date.state.value, '-')), '-')
          }
        };
    ...
    value: function render() {
      ...
      if (this.props.type === 'profile') {
        fields = (Object(_babel_runtime_corejs2_helpers_esm_readOnlyError__WEBPACK_IMPORTED_MODULE_7__["default"])("fields"), this.props.fields.slice(0, 6));
      } else {
        fields = (Object(_babel_runtime_corejs2_helpers_esm_readOnlyError__WEBPACK_IMPORTED_MODULE_7__["default"])("fields"), this.props.fields.slice(6, 9));
      }

      console.log(fields);
      console.log(profileData);
      return __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Grid"], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 53
        },
        __self: this
      }, __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Grid"].Column, {
        ...
        __self: this
      }, __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Form"], {
        ...
        __self: this
      }, lodash__WEBPACK_IMPORTED_MODULE_14___default.a.map(fields, function (field) {
        {
          console.log(field);
          console.log(profileData[field.en]);
        }
        return __jsx(_input__WEBPACK_IMPORTED_MODULE_17__["default"], {
          ref: function ref(c) {
            _this2[field.en] = c;
          },
          field: field,
      ...
      }), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Message"], {
        hidden: !success,
        positive: true,
        __source: {
          fileName: _jsxFileName,
        ...
        __self: this
      }, "\u062A\u063A\u06CC\u06CC\u0631\u0627\u062A \u0628\u0627 \u0645\u0648\u0641\u0642\u06CC\u062A \u0630\u062E\u06CC\u0631\u0647 \u0634\u062F."), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Message"], {
        hidden: !fail,
        negative: true,
        __source: {
          fileName: _jsxFileName,
        ...
        __self: this
      }, "\u062A\u063A\u06CC\u06CC\u0631\u0627\u062A \u0628\u062F\u0648\u0646 \u0645\u0648\u0641\u0642\u06CC\u062A \u0630\u062E\u06CC\u0631\u0647 \u0634\u062F."), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Form"].Button, {
        primary: true,
...
//# sourceMappingURL=profile.js.34005670895ec23e1df2.hot-update.js.map